...
export async function getAllPublicGists({page, pageSize}:FetchAllPublicGistsType) {
    const resp = await fetch(
      "https://api.github.com/gists/public?" +
        new URLSearchParams({ per_page: pageSize, page: page }.toString()),
      { headers: new Headers({
  ...
  export const editGist = async (gist_id: string | undefined, gistPostData: any) => {
